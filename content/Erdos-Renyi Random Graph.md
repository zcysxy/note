...
published: 2026-04-30T16:13:47.985-04:00
tags:
  - pub-network
state: "[[%wip]]"
sup:
...
- Basic properties
  ...
  - Local [[Transitivity|Clustering]]: $\mathbb{E}C_{i} = p_{n}$
...
We call the ER model in the regime of $p_{n} = \lambda / n$ the ==sparse ER== model.
