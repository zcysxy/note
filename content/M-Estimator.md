...
published: 2026-01-07T01:10:18.136Z
tags:
  - pub-stat
state: done
sup:
...
In the function graph of $M$ and $M_{n}$ (see e.g. [[#^fig-m-graph]]), the question ask what conditions allow to transfer the convergence of _y-axis_ to that of _x-axis_.
...
![Example of M function whose point of maximum is not well separated.](m-est-sep.excalidraw.png) ^fig-m-graph
