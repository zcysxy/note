---
publish: true
aliases: Barchart,Bar Plot
title: Bar Chart
created: 2022-10-12T22:07:38
modified: 2022-12-11T19:14:39
published: 2026-05-09T18:09:33.822-04:00
tags:
  - pub-edav
type: note
dg-publish: true
...
- For unbinned data, use `geom_bar` in [[ggplot2]]
- For binned data, use `geom_col` in [[ggplot2]]
- We can use `geom_text` to put labels directly in/on bars
- Do not color bars when it is not necessary. Colors are needed [[#For Multivariate Categorical Data]].
...
To bin the data by hand, we can use [[dplyr#summarise()]] with `group_by(category)`.
...
For [[EDAV - Multivariate Categorical Data|Multivariate Categorical Data]], instead of drawing multiple bar charts (possible with facets), we can put bars for different categories _together_ by
...
![[EDAV - Categorical Data#Likert Data]]
