...
published: 2026-01-03T12:59:27.000Z
tags:
  - pub-stat
state: done
sup:
...
where $c_{q}$ is the $q$-th quantile of the distribution of $t$, and $c_{\alpha/2}$ and $c_{1-\alpha /2}$ are called the _critical values_.
