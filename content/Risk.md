...
$$
L:\mathcal{A} \times \Theta \to \R\_{\ge\_{0}},
$$
...
- ==Bayes Risk==: $$R\_{B}(A)\coloneqq \mathbb{E}\_{\theta \sim Q}\[R(A,\theta)],\quad \text{prior }Q\in\Delta(\Theta).$$
  - Can incorporate prior knowledge about the parameter $\theta$.
  - Can be understood as the _average_ or weighted risk, with $Q$ being the weight.
- ==Minimax Risk==: $$R\_{M}(A)\coloneqq \sup\_{\theta\in\Theta }R(A,\theta).$$
  - Suitable for deterministic parameters.
  - Can be understood as the _worst-case_ risk.
