...
- It's a _discrete_ distribution, where events are intervals but not values
...
- Frequency histogram
- Density histogram
  - In a density histogram, the **area** of a bar equals the **relative frequency**; thus the y-scale is the _density_: $\text{relative frequency} / \text{binwidth}$ ^9qhqpv
  ...
  - In [[ggplot2]], use `y = ..density..` to specify this scale
  - It is also very useful to overlay a [[Density Curve]] (`geom_density()`)
