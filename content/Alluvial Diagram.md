...
published: 2026-05-11T15:41:06.505Z
tags:
  - pub-edav
aliases:
type: note
...
They use [[Parallel Coordinate]]s for [[EDAV - Multivariate Categorical Data|Multivariate Categorical Data]].
They show how data move from one category to some other categories.
Alluvial diagrams work well for data with _flows_ in it. Observations with the same movement are drawn together to show the flow.
...
![geom\_flow|500](https://raw.githubusercontent.com/zcysxy/Figurebed/master/img/20221013182109.png)

## Lodes Form

- Able to present _ghosted_ data, which doesn't have all categorical variables
