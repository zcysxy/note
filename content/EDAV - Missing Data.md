...
published: 2026-05-09T18:10:01.768-04:00
tags:
  - pub-edav
aliases:
type: note
...
[[Heatmap]]s are suitable for visualizing missing data.
...
A better idea is to combine the normal [[Heatmap]] with missing data: use one color to present missing data, and a [[Graph Color#^1dc7c8|sequential color palette]] to present the magnitude of other values.
