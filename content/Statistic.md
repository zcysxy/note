...
**Third generalization**. This is a generalization of the interpretation. Due to its general definition, any _output of a statistical procedure_ is also a statistic (if measurable), such as an [[Estimation|estimator]], [[Hypothesis Testing|test]], [[Prediction|predictor]], etc.
