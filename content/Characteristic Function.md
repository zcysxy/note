...
modified: 2024-11-13T02:49:08
published: 2026-06-27T04:53:38.060Z
tags:
  - pub-prob
state: done
sup:
...
f\_{X}(x) = \frac{1}{2\pi} \lim\_{ T \to \infty } \int \_{-T}^{T} e^{-itx} \phi \_{X}(t) ,\d t.
...
\lim\_{ n \to \infty } \phi \_{X\_n} = \phi \_{X},
