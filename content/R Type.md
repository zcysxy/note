...
publish: true
title: R Types
created: 2022-09-06T17:38:35
modified: 2022-12-11T18:40:45
published: 2026-05-09T18:10:23.171-04:00
tags:
  - pub-edav
aliases:
type: note
...
- Use function `is.x()`, such as `is.na()` and `is.complex()`, to test the type of an [[R]] object.
...
Factors are used to represent [[EDAV - Categorical Data]] and can be unordered or ordered. One can think of a factor as an integer vector where each integer has a _label_.
