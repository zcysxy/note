...
- exit selection contains the [[DOM]] elements that don't find data matches
  ...
  - matched element in the update selection will be _empty_ in the exit selection
- enter selection contains non-existent "placeholder" elements for data that don't find object matches
  ...
  - matched element in the update selection will be _empty_ in the enter selection
  - you can add _real_ elements to the placeholder elements by `selection.enter().append()`
