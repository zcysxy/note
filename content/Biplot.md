...
published: 2026-05-09T18:09:33.826-04:00
tags:
  - pub-edav
aliases:
type: note
...
- A biplot is a generalization of the simple two-variable [[Scatterplot]]
...
We can use dimension-reduction methods to select or form two main variables, then _project_ other selected/formed variables to the plane (make them linear combinations of the two main variables).
