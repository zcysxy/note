...
published: 2026-01-07T01:10:18.088Z
tags:
  - pub-stat
type: note
sup:
...
Moreover, a positive $\phi$, a positive variance ([[#^bpp]]), and a full column rank $X=(X_{1},\dots,X_{n})^T$ gives a negative definite Hessian of the log-likelihood:
